...
public class PPIDisplayDataModel extends DisplayDataModel {
    ...
    public PPIDisplayDataModel(boolean live, int totalCount, LocalDate date, ObservableList<MTEntity> data, Button renameButton, Button archiveButton, Button sendButton, Button sendToPensButton) {
